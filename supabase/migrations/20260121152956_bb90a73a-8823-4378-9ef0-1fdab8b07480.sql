-- Agregar logro de aprobar una materia con 10
INSERT INTO achievements (nombre, descripcion, icono, categoria, condicion_tipo, condicion_valor, xp_reward) VALUES
('Excelencia Pura', 'Aprobaste una materia con nota 10', 'star', 'academico', 'materia_con_10', 1, 500);

-- Crear función para verificar y desbloquear logros
